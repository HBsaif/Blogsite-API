...
urlpatterns = [
    ...
    path('view_post/comment/<int:pk>', views.CommentDetail.as_view()),
    path('view_post/<int:pk>/comment/', views.CommentList.as_view()),
    path('view_post/<int:pk>/comment-create/', views.CommentCreate.as_view()),
